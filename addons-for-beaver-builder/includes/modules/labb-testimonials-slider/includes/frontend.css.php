...
.fl-node-<?php echo $id; ?> .labb-testimonials-slider .labb-testimonial-user .labb-image-wrapper img {
<?php
    ...
    if( !empty( $settings->thumbnail_spacing ) ) {
        echo 'padding-right: '. $settings->thumbnail_spacing .'px;';
    }
?>
    }
.fl-node-<?php echo $id; ?> .labb-testimonials-slider .labb-testimonial-text i {
<?php
    if( !empty( $settings->quote_icon_color ) ) {
        echo 'color: #'. $settings->quote_icon_color .';';
    }
    if( !empty( $settings->quote_icon_size ) ) {
        echo 'font-size: '. $settings->quote_icon_size .'px;';
    }
?>
    }
.fl-node-<?php echo $id; ?> .labb-testimonials-slider .labb-testimonial-text {
<?php
    ...
    if( !empty( $settings->text_font_style ) ) {
        echo 'font-style: '. $settings->text_font_style .';';
    }
?>
    }
.fl-node-<?php echo $id; ?> .labb-testimonials-slider .labb-testimonial-text:after {
<?php
...
.fl-node-<?php echo $id; ?> .labb-testimonials-slider .labb-testimonial-user .labb-text .labb-author-name {
<?php
...
.fl-node-<?php echo $id; ?> .labb-testimonials-slider .labb-testimonial-user .labb-text {
<?php
