    ...
    public function get_img($id = null) {
        ...
        if ($id && $this->settings->image_linkable == 'yes') {
            ...
            if ($this->settings->post_link_new_window == 'yes')
                ...
                $photo_settings['link_url_target'] = '_self';
        }
                    ...
                    'fields' =>
                        array(
                            ...
                            'heading' => array(
                                ...
                                'default' => __('My Posts', 'livemesh-bb-addons'),
                            ),
                    ...
                    'fields' =>
                        array(
                            ...
                            'display_title_on_thumbnail' => array(
                                'type' => 'labb-toggle-button',
                                'label' => __('Display project title on post/project thumbnail?', 'livemesh-bb-addons'),
                                'default' => 'yes'
                            ),

                            'display_taxonomy_on_thumbnail' => array(
                                'type' => 'labb-toggle-button',
                                'label' => __('Display taxonomy info on post/project thumbnail?', 'livemesh-bb-addons'),
                                'default' => 'yes'
                            ),
                            ...
                            'display_read_more' => array(
                                'type' => 'labb-toggle-button',
                                'label' => __('Display read more link to the post/portfolio?', 'livemesh-bb-addons'),
                                'default' => 'no'
                            ),

                            'read_more_text' => array(
                                'type' => 'text',
                                'label' => __('Read More Text', 'livemesh-bb-addons'),
                                'default' => __('Read More', 'livemesh-bb-addons'),
                                'connections' => array('string', 'html'),
                            ),
                        )
                ),
